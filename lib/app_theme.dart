...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      textTheme: TextTheme(titleMedium: TextStyle(fontWeight:FontWeight.bold,color:Colors.black,fontSize: 18),
      titleSmall: TextStyle(color: AppTheme.grey,fontWeight: FontWeight.w700,fontSize: 18)),
